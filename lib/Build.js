...
class Build extends events.EventEmitter {
  ...
  /**
   * Get an object stream with the output of the steps running as a part of this build.
   * TODO: make this a getter.
   *
   * @return {ReadableStream} - An object stream containing multiplexed stdout and stderr.
   */
  getStream() {
    return this.stream;
  }
