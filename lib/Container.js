...
/**
 * @param {data} data The desired network settings.
 * @param {port} port The desired port.
 * @return {port} Get the particular exposed port from container info.
 *
 */
 ...
 * @return {function} build command info
 * /
