...
/**
 * @returns {function} - A cojure with a function that can be used to execute the script.
 */
AbstractPlugin.prototype.getRunnable = function() {
};

AbstractPlugin.prototype.getStream = function() {
  return this.output;
};
