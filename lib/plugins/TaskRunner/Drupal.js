...
class Drupal extends LAMPApp {
  ...
  constructor(container, options) {
    ...
    this.options.makeForceComplete = String(options.makeForceComplete) !== 'undefined' ? String(options.makeForceComplete).toLowerCase() === 'true' : true;
  ...
  addScriptRunMakeFile() {
    ...
    if (!Array.isArray(makeArgsList) || !makeArgsList.length) {
