...
class Drupal extends LAMPApp {
   ...
   *   @param {object} [options.generateContent] - An object describing content to create, in the format {'content_type': count, 'content_type2': count,}.
   *   @param {object} [options.generateUsers] - An object describing content to create, in the format {'role': count, 'role2': count, 'role,role2': count,}.
