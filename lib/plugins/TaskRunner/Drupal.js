...
class Drupal extends LAMPApp {
  ...
  constructor(container, options) {
    ...
    if (this.options.databaseEngine == 'pgsql') {
      this.options.nameSpace = 'Drupal\\\\\\\\Core\\\\\\\\Database\\\\\\\\Driver\\\\\\\\mysql';
    }
    else {
      this.options.nameSpace = 'Drupal\\\\\\\\Core\\\\\\\\Database\\\\\\\\Driver\\\\\\\\pgsql';
    }
  ...
  addD8PHPSettings() {
    ...
    this.script = this.script.concat([
      ...
      `      'namespace' => '${this.options.namsSpace}',`,
      `      'driver' => 'mysql',`,
      `    ),`,
      `  ),`,
      `);`,
