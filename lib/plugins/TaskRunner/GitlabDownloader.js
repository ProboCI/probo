...
module.exports = class GitlabDownloader extends require('./Script') {
  ...
  setGitlabScript() {
    ...
    var script = [
      'mkdir -p $SRC_DIR',
      'cd $SRC_DIR',
      `wget -q -O --header "Private-Token: ${params.auth_token}" https://gitlab.com/api/v3/projects/${params.repo_slug}/repository/archive?sha=${params.ref} | tar xzf - --strip-components=1`,
    ];
