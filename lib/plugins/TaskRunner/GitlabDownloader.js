...
module.exports = class GitlabDownloader extends require('./Script') {
  ...
  setGitlabScript() {
    ...
    var script = [
      'mkdir -p $SRC_DIR',
      'cd $SRC_DIR',
      `curl --header "Authorization: Bearer ${params.auth_token}" https://gitlab.com/api/v3/projects/${params.repo_slug}/repository/archive?sha=${params.ref} | tar xzf - --strip-components=1`,
    ];
