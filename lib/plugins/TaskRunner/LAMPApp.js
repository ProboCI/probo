...
class LAMPApp extends Script {
  ...
  addScriptCreateDatabase() {
    this.script = this.script.concat([
      ...
      'mysql -uroot -pstrongpassword -e \'create database \'$DATABASE_NAME',
      'if [ "$DATABASE_USER" != "root" ]; then mysql -uroot -pstrongpassword -e \'create user "\'$DATABASE_USER\'"@"localhost" identified by "\'$DATABASE_PASS\'"\'; fi',
      'mysql -uroot -pstrongpassword -e \'grant all on \'$DATABASE_NAME\'.* to "\'$DATABASE_USER\'"@"localhost"\'',
