...
class LAMPApp extends Script {
   ...
   *   @param {boolean} [options.varnish] - Indicate whether to use varnish http cache or not.  Defaults to false.
   */
  constructor(container, options) {
    ...
    this.options.varnish = options.varnish || false;
  ...
  addVarnishSetup() {
    ...
    this.script.push('a2enmod listen_8080');
