...
class LAMPApp extends Script {
  ...
  addScriptCreateDatbase(siteOptions) {
    siteOptions = siteOptions || this;
    this.script = this.script.concat([
      'echo \'Creating MySQL Database, user and granting access.\'',
      'mysql -e \'create database ' + siteOptions.databaseName + '\'',
      'mysql -e \'grant all on ' + siteOptions.databaseName + '.* to "root"@"localhost"\'',
