...
class LAMPApp extends Script {
  ...
  addScriptCreateDatabase() {
    this.script = this.script.concat([
      ...
      'mysql --defaults-extra-file=/root/.probo.cnf -e \'create database \'$DATABASE_NAME',
      ...
      'mysql --defaults-extra-file=/root/.probo.cnf -e \'grant all on \'$DATABASE_NAME\'.* to "\'$DATABASE_USER\'"@"localhost"\'',
