 ...
 *
 * TODO: This should be broken up and moved out of the controller - this belongs in the container and it seems way more complicated than it needs to be...
 */
Server.prototype.runBuild = function* (build, log) {
  var self = this

  // TODO: Log more information about the build.
