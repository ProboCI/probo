...
Server.prototype.constructBuild = function(buildConfig, log) {
...
Server.prototype.prepareSteps = function(jobConfig) {
};

Server.prototype.runBuild = function(buildConfig, log, done) {
  var self = this;
...
Server.prototype.createContainerConfig = function(build) {
