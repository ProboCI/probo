...
Server.prototype.runBuild = function* (build, log) {
  ...
  log.debug({build, containerConfig}, `Starting container build: ${containerName} for ${project.slug.provider}:${project.name}`);
 ...
 * @return {Promise} - A promise with the build data.
 */
