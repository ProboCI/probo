 ...
 *
 * @param {Dockerode.Container} container - Dockerode Container instance
 * @return {Dockerode.Container} the patched instance (also modified in place)
 */
module.exports = function patchContainerInspect(container){
   ...
   */
  container.inspect = function(opts, callback) {
