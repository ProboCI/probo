...
class GitHubHandler {
   ...
   * @param {(err: Error, [res]) => void} cb cb - The callback to be called
   ...
   * @param {(err: Error, [res]) => void} cb - The callback to be called after
   ...
   * @param {(err: Error, [res]) => void} cb - The callback to call when
   *   finished.
   */
